...
class Clinic_controller extends CI_Controller
{
 ...
 //receptionist
  ...
  //   $data['bill_id_fk']=$this->input->post('bill_id_fk');

  //   $this->payment_model->insertpayment($data);
  //   redirect('Clinic_controller/showpayment');
  // }
  // public function showpayment()
  // { 
  //    $data['user_type'];
  //   $data['payment_data']=$this->payment_model->paymentlist();
  //   $this->load->view('admin/showpayment',$data);
  // }
  // public function editpayment($id)
  // {
  //    $data['user_type'];
  //   $data['payment_data']=$this->payment_model->paymentdata($id);
  //   $this->load->view('admin/addpayment',$data);
  // }
  // public function updatepayment()
  // {
  //   $data['payment_id_pk']=$this->input->post('payment_id_pk');
  //   $data['payment_type']=$this->input->post('payment_type');
  //   $data['bill_id_fk']=$this->input->post('bill_id_fk');
  ...
  //   $data['treatment_data']=$this->treatment_model->treatmentlist();
  //   $data['medicine_data']=$this->medicine_model->medicinelist();
  //   $this->load->view('admin/addprescription',$data);
  // }
  ...
  // // public function getpricebymedicine()
  // // {
  // //    $medicine=$this->input->post('medicine_name01');

  // //   $data=$this->bill_model->pricelistbymedicine($medicine);
