...
<div class="column">
	<table id="box">
		...
		<tr>
			<th>
				<a href="<?php echo base_url();?>Client_controller/appointmentdetail" id="addRow"class="btn btn-info">Appoitment History</a>
			</th> 
			<td></td>
		</tr>
		...
		<tr>
			<th>
				<a href="<?php echo base_url();?>Client_controller/billdetail" id="addRow"class="btn btn-info">Bill History</a>
			</th>
			<td></td>
		</tr>
	</div>
