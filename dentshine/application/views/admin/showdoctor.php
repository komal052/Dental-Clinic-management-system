									...
									<div class="card-body ">
										<div class="row">
											<div class="col-md-6 col-sm-6 col-xs-6">
												<div class="btn-group">
												<a href="<?php echo base_url();?>Clinic_controller/adddoctor" id="addRow"
													class="btn btn-info">
													...
													<div class="card-body no-padding ">
														<div class="doctor-profile">
															...
															<div class="profile-usertitle">
 															...
 															<div class="name-center">Degree:<?php echo $doctor['degree'];?></div>

                                                             <div class="name-center">Experience:<?php echo $doctor['experience'];?></div>
                                                              <div class="name-center">Email id:<?php echo $doctor['email_id'];?></div>
															 </div>
															...
															<div>
																<p><i class="fa fa-phone"></i><a
																		href=""> <?php echo $doctor['mobile_no'];?></a></p>
															</div>
