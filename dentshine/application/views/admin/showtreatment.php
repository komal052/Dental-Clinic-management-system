				   ...
				   <div class="col-md-12">
									...
									<div class="card-body ">
										<div class="row">
											<div class="col-md-6 col-sm-6 col-xs-6">
												<div class="btn-group">
												<a href="<?php echo base_url();?>Clinic_controller/addtreatment" id="addRow"
													class="btn btn-info">
					  ...
					  <tr>
                         ...
                         <td><?php echo $treatment['description'];?></td>
                            ...
                            <td>
							<a href="<?php echo base_url();?>Clinic_controller/edittreatment/<?php echo $treatment['treatment_id_pk']; ?>" class="btn btn-primary btn-xs">		
								<i class="fa fa-pencil"></i>
							</a>
							<a href="<?php echo base_url();?>Clinic_controller/deletetreatment/<?php echo $treatment['treatment_id_pk']; ?>" class="btn btn-danger btn-xs">
