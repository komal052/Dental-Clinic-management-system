						...
						<div class="col-md-12">
							<div class="tabbable-line">
								...
								<div class="tab-content">
								    ...
								    <div class="btn-group">
								<a href="<?php echo base_url()?>Clinic_controller/addpatient" id="addRow"
									class="btn btn-info">
						...
						<tbody>
                          ...
                          foreach($patient_data as $patient)
                          {
                           ...
                           <tr>
                            ...
                            <td>
							<a href="<?php echo base_url();?>Clinic_controller/editpatient/<?php echo $patient['patient_id_pk']; ?>" class="btn btn-primary btn-xs">		
								<i class="fa fa-pencil"></i>
							</a>
							<a href="<?php echo base_url();?>Clinic_controller/deletepatient/<?php echo $patient['patient_id_pk']; ?>" class="btn btn-danger btn-xs">
										...
										<div class="card card-topline-aqua">
											<div class="card-body no-padding ">
												<div class="doctor-profile">
													...
													<img src="<?php echo base_url().$patient['picture'];?>"  class="doctor-pic" >
													<div class="profile-usertitle">
														...
														<div class="name-center">Address:<?php echo $patient['address'];?></div>

                                                 
                                                      <div class="name-center">Email id:<?php echo $patient['email_id'];?></div>
													 </div>
